package com.car_rental_system.car_Rental_system_be.entity;
...
public class BookACar {
    ...
    public BookACarDto getBookACarDto() {
        ...
        bookACarDto.setBrand(this.car.getBrand());
        bookACarDto.setColor(this.car.getColor());
        bookACarDto.setName(this.car.getName());
        bookACarDto.setType(this.car.getType());
        bookACarDto.setTransmission(this.car.getTransmission());
        System.out.println("bookACarDto:bookACarDto");
        return bookACarDto;
    }
}
